...
export default async function UserPage({
  ...
  return (
    <>
      {/* Subnav - outside main container for full width */}
      <nav className="sticky top-13 h-11 z-10 bg-zinc-50 dark:bg-zinc-950 border-b border-zinc-200 dark:border-zinc-800">
        <div className="max-w-lg mx-auto px-4 py-3 flex gap-3 text-sm">
          <a
            href="#profile"
